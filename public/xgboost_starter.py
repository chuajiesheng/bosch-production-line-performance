# Source: https://www.kaggle.com/joconnor/bosch-production-line-performance/python-xgboost-starter-0-209-public-mcc/notebook
# Install xgboost by hand is needed: https://xgboost.readthedocs.io/en/latest/build.html
...
X = pd.concat([pd.concat([dchunk, nchunk], axis=1).sample(frac=1)
